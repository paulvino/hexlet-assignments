...
public class AppTest {
    ...
    void testUpdatePerson() throws Exception {
        MockHttpServletResponse response = mockMvc
                .perform(
                        patch("/people/1")
                                ...
                                .content("{\"firstName\": \"Josh\", \"lastName\": \"Doe\"}")
                )
                .andReturn()
                .getResponse();
        ...
        MockHttpServletResponse showResponse = mockMvc
                .perform(get("/people"))
                .andReturn()
                .getResponse();
        ...
        assertThat(showResponse.getContentAsString()).contains("Josh", "Doe");
